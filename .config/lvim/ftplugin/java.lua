-- You need to run this from the vim cmd line for debugger to work!!!
...
local config = {
  cmd = {
    ...
    "-jar", vim.fn.glob(home .. "/.local/share/lvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"),
    "-configuration", home .. "/.local/share/lvim/mason/packages/jdtls/config_" .. os_config,
    "-data", workspace_dir,
  },
