...
local forStatement = ls.s(
  ...
  ls.fmt(
  ...
  ]],
    {
      ...
      ls.d(4, function(args) return ls.sn(nil, ls.i(1, "++" .. args[1][1])) end, 1),
      ls.i(5),
    }
  )
)
...
local guard = ls.s(
  ...
  ls.fmt(
    ...
    {
      ls.f(function(_, snip) return pascalToScreamingSnake(snip.env.TM_FILENAME) end, _, { key = "guardName" }),
